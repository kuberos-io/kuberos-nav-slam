...
def main(args=sys.argv):
    ...
    parser.add_argument('--localization-mode', required=True, choices=['amcl', 'slamtoolbox', 'rtabmap'], help='Localization mode')
    ...
    if arguments.localization_mode == 'amcl':
        ...
        if arguments.start:
            ...
            try:
                ...
                navigator.error("Invalid start values in:", start_vals, "(expected floats)")
                sys.exit(-1)
        else:
